...
int main(){
    ...
    cout<<"The maximum limit of long long int data type is: "<<LLONG_MAX<<endl;
    cout<<"The minimum limit of long long int data type is: "<<LLONG_MIN<<endl;
    cout<<"The maximum limit of unsigned long long int data type is: "<<ULONG_LONG_MAX<<endl;
    cout<<"The Bits contain in char is: "<<CHAR_BIT<<endl;
